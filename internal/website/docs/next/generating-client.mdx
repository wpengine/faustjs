...
We use a framework called [GQless](https://gqless.com) under the hood to faciliate GraphQL queries. GQless works by typing out your entire WordPress instance to a usable TypeScript object.
