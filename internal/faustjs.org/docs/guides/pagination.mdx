...
Go to the components directory of your Faust project and create a file called `LoadMorePost.js` and insert this content:
...
Once this is all done, to make sure it is working, go to the `pages` directory in the root of the Faust project, create a file called `pagination.js` and insert this content:
