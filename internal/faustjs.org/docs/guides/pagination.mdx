...
The apply method with the hooks param which is an object that gives you a function called `addFilter` allows us to modify Apollo's `InMemorycCacheOptions`.
