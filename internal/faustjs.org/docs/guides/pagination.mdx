...
Once this is all done, to make sure it is working, go to the `pages` directory in the root of the Faust app, and create a file.  Let's call it `pagination.js`.  Insert this content:
