...
The `seedQuery` parameter is the data resulted from the seed query. You can learn more about the [request and response of the seed query here.](/docs/seed-query)
