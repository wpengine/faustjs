...
- Automatic installation of required WordPress plugins ([Faust](https://wordpress.org/plugins/faustwp/), [WPGraphQL](https://wordpress.org/plugins/wp-graphql/), etc.)
...
If deploying from the Atlas portal using your own repository (without beginning with a blueprint), you will need to set your environment variables manually. Learn how by taking a look at our [FAQs](/docs/faq).
