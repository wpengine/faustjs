...
It co-locates the GraphQL query within the same file. You can also import it from a file.
...
`@faustwp-core` package. Instead you can customize it by using a [plugin filter](http://localhost:3000/docs/plugin-system/filters).
