...
To ensure certain features of Faust function as expected, such as previews, be sure to set the Front-end Site URL in the Headless WordPress Plugin Settings. It is the URL to your headless front-end. This is used for authenticated post previews and for rewriting links to point to your front-end site.

1. Navigate to the `Headless WordPress Plugin` settings page
