...
[Take a look at the Getting Started example for a closer look at these changes.](https://github.com/wpengine/faustjs/tree/canary/examples/next/getting-started)
