...
We use [GQty](https://gqty.dev) as our GraphQL client. To configure GQty, we need to create a `gqty.config.cjs` file in the root of our project.

```js title=gqty.config.cjs
