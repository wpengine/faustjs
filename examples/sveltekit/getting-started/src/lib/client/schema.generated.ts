...
export const generatedSchema = {
	...
	DatabaseIdentifier: { __typename: { __type: 'String!' }, databaseId: { __type: 'Int!' } },
	...
	NodeWithTemplate: { __typename: { __type: 'String!' }, template: { __type: 'ContentTemplate' } },
	ContentTemplate: { __typename: { __type: 'String!' }, templateName: { __type: 'String' } },
	NodeWithTitle: {
		__typename: { __type: 'String!' },
		title: { __type: 'String', __args: { format: 'PostObjectFieldFormatEnum' } }
	},
	...
	NodeWithPageAttributes: { __typename: { __type: 'String!' }, menuOrder: { __type: 'Int' } },
	...
	MenuItemsWhereArgs: { id: { __type: 'Int' }, location: { __type: 'MenuLocationEnum' } },
	DefaultTemplate: { __typename: { __type: 'String!' }, templateName: { __type: 'String' } },
	Template_FullWidth: { __typename: { __type: 'String!' }, templateName: { __type: 'String' } },
	[SchemaUnionsKey]: {
 ...
 * The template assigned to the node
 */
export interface Template_FullWidth extends Omit<ContentTemplate, '__typename'> {
