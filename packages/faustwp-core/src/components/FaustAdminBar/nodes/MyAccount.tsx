  ...
  return (
    <li
      ...
      <a className="ab-item" href={profileUrl}>
        ...
        <img
          alt=""
          src="http://0.gravatar.com/avatar/cbe4ce55c088edd60fe400147668989e?s=26&amp;d=mm&amp;r=g"
          srcSet="http://0.gravatar.com/avatar/cbe4ce55c088edd60fe400147668989e?s=52&amp;d=mm&amp;r=g 2x"
        ...
        <ul id="wp-admin-bar-user-actions" className="ab-submenu">
          <li id="wp-admin-bar-user-info">
            <a className="ab-item" tabIndex={-1} href={profileUrl}>
              <img
                alt=""
                src="http://0.gravatar.com/avatar/cbe4ce55c088edd60fe400147668989e?s=64&amp;d=mm&amp;r=g"
                srcSet="http://0.gravatar.com/avatar/cbe4ce55c088edd60fe400147668989e?s=128&amp;d=mm&amp;r=g 2x"
          ...
          <li id="wp-admin-bar-logout">
            <a
              className="ab-item"
              href="http://faustwp-symlink.local/wp-login.php?action=logout&amp;_wpnonce=3fe2939cc1">
              Log Out
            </a>
          </li>
        </ul>
