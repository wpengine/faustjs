 ...
 */
function post_preview_link( $link ) {
	if ( ! isset( $link ) ) {
		return;
	}
...
function enqueue_preview_scripts() {
	...
	wp_localize_script( 'faustwp-gutenberg-filters', '_faustwp_preview_link', array( '_preview_link' => post_preview_link( get_preview_post_link(), get_post() ) ) );
}
